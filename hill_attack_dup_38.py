...
output:
Provide two plaintext 2-letter blocks and corresponding ciphertext 2-letter blocks.
Plain1 (2 letters): hi
Plain2 (2 letters): ab
Cipher1 (2 letters): tc
Cipher2 (2 letters): df
Recovered 2x2 key matrix (row-major):
[3 3]
[2 5]
